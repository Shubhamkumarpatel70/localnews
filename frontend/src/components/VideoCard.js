...
export default function VideoCard({
  ...
  return (
    <div className="video-card">
      {shortsStyle ? (
        <div
          className="video-card-media-wrapper"
          style={{ aspectRatio: shortsRatio }}
        >
          <video
          ...
          >
            ...
            <div
              className="video-card-overlay-actions-vertical"
              style={{
                display: "flex",
            ...
            >
              ...
              >
                ...
                <div style={{ fontSize: 13, color: "#222", marginTop: 2 }}>
              ...
              >
                {video.saved ? (
                  <BookmarkIcon style={{ color: "#B71C1C" }} />
                ) : (
                  <BookmarkBorderIcon style={{ color: "#222" }} />
                )}
              </button>
            </div>
            ...
            >
              <div
                className="video-card-overlay-profile"
                style={{
                  display: "flex",
                  alignItems: "center",
                  gap: 10,
                ...
                onClick={() =>
                  navigate(`/user/${video.author?.username || "unknown"}`)
                }
              >
                <img
                ...
                >
                  ...
                  {video.author?.verified && (
                    <CheckCircleIcon
                      style={{ color: "#2196f3", fontSize: 17, marginLeft: 2 }}
                    />
                  )}
                  <button
              ...
              <div
                className="video-card-overlay-title"
                style={{
                  color: "#fff",
                  fontSize: 19,
                  fontWeight: 700,
                  ...
                  overflow: "hidden",
                  textOverflow: showFullTitle ? "clip" : "ellipsis",
                  lineHeight: 1.3,
                  display: "flex",
                  alignItems: "center",
                  position: "relative",
              ...
              >
                ...
                >
                  {showFullTitle || !isTitleLong
                    ? video.title
                    : video.title.slice(0, titleMaxLength) + "..."}
                  {!showFullTitle && isTitleLong && (
                    <span
                      style={{
                        position: "absolute",
            ...
            <div
              style={{
                ...
                background:
                  "linear-gradient(to top, rgba(0,0,0,0.55) 70%, rgba(0,0,0,0.0) 100%)",
                zIndex: 1,
                pointerEvents: "none",
              }}
            />
      ...
      <div className="video-card-controls">
        {isPlaying ? (
          ...
          <button onClick={handlePlay} className="video-play-btn" title="Play">
            <PlayArrowIcon />
          </button>
        )}
      </div>
      {!shortsStyle && (
        <div className="video-card-content">
          ...
          <div className="video-card-meta">
            <span className="video-card-author">
          ...
          <div className="video-card-actions">
            <button
              ...
              title="Like"
            >
              {video.liked ? <FavoriteIcon /> : <FavoriteBorderIcon />}{" "}
              {typeof video.likes === "number"
                ? video.likes
                : Array.isArray(video.likes)
                ? video.likes.length
